...
2) For each entry in tasks:
   ...
   - Create file: docs/TASK-####-<kebab-title>.md using the established atomic task template (the one provided earlier).
...
3) After creating all tasks:
   - Write an index file at docs/INDEX.md listing TASK-####, titles, owners, priorities, epic links.
